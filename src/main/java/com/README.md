...
[root@bigdata-pro02 ~]# /home/opt/modules/zookeeper-3.4.5-cdh5.10.0/bin/zkServer.sh start
[root@bigdata-pro03 ~]# /home/opt/modules/zookeeper-3.4.5-cdh5.10.0/bin/zkServer.sh start
```
hadoop
```
...
[root@bigdata-pro02 ~]# supervisord -c /etc/supervisor/supervisord.conf
[root@bigdata-pro03 ~]# supervisord -c /etc/supervisor/supervisord.conf
...
supervisorctl start storm-logviewer
