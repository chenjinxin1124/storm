package start.case6TridentTest.operations.n09chainingAggre;
...
public class Demo {
    ...
    public static StormTopology buildTopology() {
        ...
        topology.newStream("spout", spout)
                ...
                .chainedAgg()// 调用链开始
                .partitionAggregate(new Fields("_date", "amt"), new Aggregate.CombinerAggre(), new Fields("amt_sum"))
                .partitionAggregate(new Fields("_date", "amt"), new Aggregate.CombinerAggreCount(), new Fields("count"))
                .chainEnd()// 调用链结束
                .each(new Fields("_date", "amt_sum", "count"), new Filter.PrintFilter())
        ;
