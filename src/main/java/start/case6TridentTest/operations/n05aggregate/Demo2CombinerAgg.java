...
public class Demo2CombinerAgg {
    ...
    public static StormTopology buildTopology() {
        ...
        topology.newStream("spout", spout)
                ...
                .aggregate(new Fields("_date", "amt"), new Aggregate.CombinerAggre(), new Fields("_amt"))// BaseAggregator, CombinerAggregator, ReducerAggregator
